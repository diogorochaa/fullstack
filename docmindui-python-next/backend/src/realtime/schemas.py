...
from src.schemas.ai import AIImagePayload as VisionImage
...
class AiAskPayload(BaseModel):
    ...
    images: list[VisionImage] = Field(default_factory=list, max_length=4)
    ...
    def normalize_legacy_image(self) -> "AiAskPayload":
    ...
    @model_validator(mode="after")
    def question_or_attachments(self) -> "AiAskPayload":
